...
public class userServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) 
        ...
        if(req.getParameter("deleteUserId")!=null){
            System.out.println("Delete user id: "+req.getParameter("deleteUserId"));
            deleteUser(req, res);
        }
    }
    ...
    private void deleteUser(HttpServletRequest req, HttpServletResponse res) 
        ...
        int deleteId = Integer.parseInt(req.getParameter("deleteUserId"));
        boolean status = userDAO.deleteUser(deleteId);
        if(status==true){
            System.out.println("user deleted!");
            res.sendRedirect("cms/index.jsp?page=userList");
        }else{
