...
public class SqlTimestampValueFactoryTest extends CommonAsserts {
    ...
    public void testCreateFromTimestamp() {
        ...
        assertThrows(WrongArgumentException.class, "YEAR", () -> {
        ...
        assertThrows(WrongArgumentException.class, "MONTH", () -> {
        ...
        assertThrows(WrongArgumentException.class, "DAY_OF_MONTH", () -> {
    ...
    public void testCreateFromLong() {
        assertThrows(DataConversionException.class, "Unsupported conversion from LONG to java.sql.Timestamp", () -> {
    ...
    public void testCreateFromBigInteger() {
        assertThrows(DataConversionException.class, "Unsupported conversion from BIGINT to java.sql.Timestamp", () -> {
    ...
    public void testCreateFromBigDecimal() {
        assertThrows(DataConversionException.class, "Unsupported conversion from DECIMAL to java.sql.Timestamp", () -> {
    ...
    public void testCreateFromBytes() {
        ...
        assertThrows(DataConversionException.class, "Cannot convert string '' to java.sql.Timestamp value", () -> {
            SqlTimestampValueFactoryTest.this.vf.createFromBytes("".getBytes(), 0, 0, f);
            return null;
        });
        ...
        assertThrows(DataConversionException.class, "Cannot convert string '-1.0' to java.sql.Timestamp value", () -> {
            SqlTimestampValueFactoryTest.this.vf.createFromBytes("-1.0".getBytes(), 0, 4, f);
            return null;
        });

        assertThrows(DataConversionException.class, "Cannot convert string 'just a string' to java.sql.Timestamp value", () -> {
