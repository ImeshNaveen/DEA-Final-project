...
public class LocalDateTimeValueFactoryTest extends CommonAsserts {
    ...
    public void testCreateFromLong() {
        assertThrows(DataConversionException.class, "Unsupported conversion from LONG to java.time.LocalDateTime", () -> {
    ...
    public void testCreateFromBigInteger() {
        assertThrows(DataConversionException.class, "Unsupported conversion from BIGINT to java.time.LocalDateTime", () -> {
    ...
    public void testCreateFromDouble() {
        assertThrows(DataConversionException.class, "Unsupported conversion from DOUBLE to java.time.LocalDateTime", () -> {
    ...
    public void testCreateFromBigDecimal() {
        assertThrows(DataConversionException.class, "Unsupported conversion from DECIMAL to java.time.LocalDateTime", () -> {
    ...
    public void testCreateFromBytes() {
        ...
        assertThrows(DataConversionException.class, "Cannot convert string '' to java.time.LocalDateTime value", () -> {
            LocalDateTimeValueFactoryTest.this.vf.createFromBytes("".getBytes(), 0, 0, f);
            return null;
        });
        ...
        assertThrows(DataConversionException.class, "Cannot convert string '-1.0' to java.time.LocalDateTime value", () -> {
            LocalDateTimeValueFactoryTest.this.vf.createFromBytes("-1.0".getBytes(), 0, 4, f);
            return null;
        });

        assertThrows(DataConversionException.class, "Cannot convert string 'just a string' to java.time.LocalDateTime value", () -> {
