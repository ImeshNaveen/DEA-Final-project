...
<!-- Mirrored from risingtheme.com/html/demo-partsix/partsix/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Apr 2024 17:35:47 GMT -->
<head>
  <meta charset="utf-8">
  <title>Partsix - Contact Us</title>
...
<body>
    ...
    <main class="main__content_wrapper">
        ...
        <section class="contact__section section--padding">
            <div class="container">
                <div class="contact__section--heading text-center mb-40">
                    ...
                    <p class="contact__section--heading__desc">To buy any vehicle spare parts online, to sell your spare parts, to know all the details contact us.</p>
                </div>
                <div class="main__contact--area position__relative">
                    <div class="contact__form">
                        <h3 class="contact__form--title mb-30">Contact Us</h3>
                        ...
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white"><a href="tel:+94 76 025 4822">+94 76 025 4822</a> <a href="tel:+94 75 370 3121">+94 75 370 3121</a>   </p>
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white"> <a href="digitalpanchikawatta@gmail.com">digitalpanchikawatta@gmail.com</a></p> 
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white">  131 Main street ,<br>
                                        Horana,<br>
                                        Sri Lanka.</p> 
                                </div>
                            </div>
        ...
        <div class="contact__map--area section--padding pt-0">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63398.57716668091!2d80.02368621430763!3d6.719588872540676!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae24b475a084f91%3A0xf0beeaf3b66bd8be!2sHorana!5e0!3m2!1sen!2slk!4v1713815817052!5m2!1sen!2slk" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </div>
