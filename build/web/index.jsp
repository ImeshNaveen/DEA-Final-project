                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                        <article class="product__card">
                                            ...
                                            <div class="product__card--content">
                                                ...
                                                <h3 class="product__card--title"><a href="product-details.jsp?productId=<%= prod.getId() %>"><%= prod.getName() %></a></h3>
                                                <div class="product__card--price">
                                                    <span class="current__price">Rs. <%= prod.getPrice() %></span>
                                                </div>
                                                <div class="product__card--footer">
                                                    <a class="product__card--btn primary__btn" href="cartServlet/insertCart?productId=<%= prod.getId() %>">
