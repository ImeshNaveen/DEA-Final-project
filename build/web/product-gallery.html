...
<!-- Mirrored from risingtheme.com/html/demo-partsix/partsix/product-gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Apr 2024 17:35:43 GMT -->
<head>
  <meta charset="utf-8">
  <title>Partsix - Product Gallery</title>
                ...
                <div class="row row-cols-1">
                    <div class="col">
                            <ul class="breadcrumb__content--menu d-flex justify-content-center">
                                ...
                                <li class="breadcrumb__content--menu__items"><span>Product Gallery</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <div class="product__details--gallery">
                            <div class="row row-cols-2">
                                <div class="col mb-28">
                                    <img class="display-block" src="assets/img/product/big-product/product2.webp" alt="product gallery img">
                                </div>
                                <div class="col mb-28">
                                    <img class="display-block" src="assets/img/product/big-product/product3.webp" alt="product gallery img">
                                </div>
                                <div class="col mb-28">
                                    <img class="display-block" src="assets/img/product/big-product/product4.webp" alt="product gallery img">
                                </div>
                                <div class="col mb-28">
                                    <img class="display-block" src="assets/img/product/big-product/product7.webp" alt="product gallery img">
                                </div>
                            </div>
                        </div>
                    </div>   
