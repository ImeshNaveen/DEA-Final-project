    <%@ page import="cartPackage.Cart, cartPackage.CartDAO" %>
    ...
    <%
        ...
        if(session.getAttribute("userId") != null){
            ...
            Cart cart = new Cart((Integer)session.getAttribute("userId") , productId);
            System.out.println("Product id: "+cart.getProduct_id());
            System.out.println("User_id: "+cart.getUser_id());
            CartDAO cartobj = null;
            cartobj.insertProduct(cart);
        }else{
...
<head>
  <meta charset="utf-8">
  <title>Panchikawaththa - Cart</title>
