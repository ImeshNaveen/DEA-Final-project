        ...
        <div class="container-fluid">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                <div class="offcanvas__header--menu__open ">
                    <a class="offcanvas__header--menu__open--btn" href="javascript:void(0)" data-offcanvas id="custom_color">
                        <svg xmlns="http://www.w3.org/2000/svg" class="ionicon offcanvas__header--menu__open--svg" viewBox="0 0 512 512"><path fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M80 160h352M80 256h352M80 352h352"/></svg>
                        <span class="visually-hidden">Offcanvas Menu Open</span>
                    </a>
                </div>
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="index.jsp"><img class="main__logo--img" src="assets/img/logo/main_logo.png" alt="logo-img" length="1700" width="200"></a></h1>
                </div>
                ...
                <div class="header__account">
                    <ul class="header__account--wrapper d-flex align-items-center">
                        ...
                        <li class="header__account--items d-none d-lg-block">
                            <a class="header__account--btn" href="userServlet/dashboard"id="custom_color">
        ...
        <div class="offcanvas__inner">
            ...
            <nav class="offcanvas__menu">
                ...
                <div class="offcanvas__account--items">
                    <a class="offcanvas__account--items__btn d-flex align-items-center" href="userServlet/dashboard">
                        <span class="offcanvas__account--items__icon" id="custom_color"> 
                            <svg xmlns="http://www.w3.org/2000/svg"  width="20.51" height="19.443" viewBox="0 0 512 512"><path d="M344 144c-3.92 52.87-44 96-88 96s-84.15-43.12-88-96c-4-55 35-96 88-96s92 42 88 96z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/><path d="M256 304c-87 0-175.3 48-191.64 138.6C62.39 453.52 68.57 464 80 464h352c11.44 0 17.62-10.48 15.65-21.4C431.3 352 343 304 256 304z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"/></svg> 
                        </span>
                        <span class="offcanvas__account--items__label" id="custom_color">Login / Register</span>
                    </a>
                </div>
                <div class="offcanvas__account--wrapper d-flex">
                    ...
                    <div class="language__currency--list">
                        <a class="offcanvas__language--switcher" href="javascript:void(0)">
                            <span id="custom_color">English</span> 
                            <svg xmlns="http://www.w3.org/2000/svg" width="9.797" height="6.05" viewBox="0 0 9.797 6.05">
                                <path  d="M14.646,8.59,10.9,12.329,7.151,8.59,6,9.741l4.9,4.9,4.9-4.9Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                            </svg>
                        </a>
        ...
        <ul class="d-flex justify-content-between">
            <li class="offcanvas__stikcy--toolbar__list">
                ...
                <span class="offcanvas__stikcy--toolbar__icon" id="custom_color"> 
                    ...
                    <span class="offcanvas__stikcy--toolbar__label" id="custom_color">Home</span>
                </a>
            </li>
            <li class="offcanvas__stikcy--toolbar__list">
                ...
                <span class="offcanvas__stikcy--toolbar__label" id="custom_color">Shop</span>
                </a>
            </li>
            <li class="offcanvas__stikcy--toolbar__list ">
                ...
                <span class="offcanvas__stikcy--toolbar__label" id="custom_color">Search</span>
                </a>
            </li>
            <li class="offcanvas__stikcy--toolbar__list">
                <a class="offcanvas__stikcy--toolbar__btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                    ...
                    <span class="offcanvas__stikcy--toolbar__label" id="custom_color">Cart</span>
                    <span class="items__count">3</span> 
                </a>
            </li>
            <li class="offcanvas__stikcy--toolbar__list">
