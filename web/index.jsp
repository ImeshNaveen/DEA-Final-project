...
<head>
  <meta charset="utf-8">
  <title>Digital Panchikawattha</title>
        ...
        <section class="hero__slider--section">
            <div class="slider__thumbnail--style5 position-relative">
                ...
                <div class="hero__content--style5 text-center">
                    <h2 class="hero__content--style5__title h1">Comes Width The <br><span class="under-word">Ultimate Protection</span></h2>
                </div>
         ...
         <section class="product__section section--padding  pt-0">
            <div class="container">
                <div class="section__heading section__heading--flex border-bottom d-flex justify-content-between mb-30">
                    <h2 class="section__heading--maintitle">Recent <span>Products</span></h2>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                        <article class="product__card">
                                            <div class="product__card--thumbnail">
                                                <a class="product__card--thumbnail__link display-block" href="product-details.jsp">
                                            ...
                                            <div class="product__card--content">
                                                ...
                                                <h3 class="product__card--title"><a href="product-details.jsp?productId=1"><c:out value="${oneProduct.name}"/></a></h3>
                                                <div class="product__card--price">
                                                    <span class="current__price"><c:out value="${oneProduct.price}"/></span>
                        
                                                </div>
                                                <div class="product__card--footer">
                                                    <a class="product__card--btn primary__btn" href="cart.jsp">
