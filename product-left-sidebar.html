...
<!-- Mirrored from risingtheme.com/html/demo-partsix/partsix/product-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Apr 2024 17:35:42 GMT -->
<head>
  <meta charset="utf-8">
  <title>Partsix - Product Left Sidebar</title>
                                ...
                                <li class="header__menu--items mega__menu--items">
                                    ...
                                    <ul class="header__mega--menu d-flex">
                                        ...
                                        <li class="header__mega--menu__li fullscreen__style d-flex">
                                            <a class="header__mega--menu__banner display-block" href="shop.html"><img class="header__mega--menu__banner--img" src="assets/img/banner/banner1.webp" alt="banner-menu">
                                            ...
                                            <a class="header__mega--menu__banner display-block" href="shop.html"><img class="header__mega--menu__banner--img" src="assets/img/banner/banner2.webp" alt="banner-menu">
                                    ...
                                    <ul class="categories__submenu border-radius-10 d-flex justify-content-between">
                                        ...
                                        <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="shop.html"><strong>Fluids & Chemicals</strong></a>
                                            <ul class="categories__submenu--child">
                                                ...
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="shop.html"> Paintworks
                                                </a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="categories__submenu--items">
                                            <a class="categories__submenu--thumbnail" href="shop.html">
                                                <img src="assets/img/product/main-product/product1.webp" alt="categories-img">
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="categories__submenu style2 border-radius-10 d-flex justify-content-between">
                                        ...
                                        <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="shop.html"><strong>Engine & Drivetrain</strong></a>
                                            <ul class="categories__submenu--child">
                                                ...
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="shop.html">Hoods </a></li>
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="shop.html">Fog Lights </a></li>
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="shop.html"> Engine Partses </a></li>
                                            </ul>
                                        </li>
                                        <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="shop.html"><strong>Body Parts</strong></a>
                                            <ul class="categories__submenu--child">
                        ...
                        <div class="header__menu">
                            <nav class="header__menu--navigation">
                                <ul class="header__menu--wrapper d-flex">
                                    ...
                                    <li class="header__menu--items mega__menu--items">
                                        <a class="header__menu--link text-white active" href="shop.html">Shop 
                                            <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                                <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                            </svg>
                                        </a>
                        ...
                        <div class="product__details--sidebar__wrapper">
                            <div class="product__sidebar--wrapper__top section--padding pt-0">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-12 col-md-6">
                                        <div class="product__details--info style2">
                                            <form action="#">
                            ...
                            <div class="product__details--tab__section sidebar__tab--section border-radius-10">
                                    ...
                                    <div class="tab_content">
                                        <div id="description" class="tab_pane active show">
                                            <div class="product__tab--content">
                                                ...
                                                <div class="product__tab--content__step style2 product__tab--content__flex d-flex align-items-center mb-30">
                                                    <div class="product__tab--content__banner style2">
                                                        <img class="product__tab--content__banner--img border-radius-5" src="assets/img/other/car-banner-img.webp" alt="banner-img">
                                                    </div>
                                                    <div class="product__tab--content__right style2">
...
<!-- Mirrored from risingtheme.com/html/demo-partsix/partsix/product-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Apr 2024 17:35:43 GMT -->
</html>