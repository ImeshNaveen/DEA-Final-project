                ...
                <div class="header__topbar--inner d-flex align-items-center justify-content-between">
                    ...
                    <div class="header__top--right d-flex align-items-center">
                        ...
                        <ul class="social__share style5 d-flex">
                            ...
                            <li class="social__share--list">
                                <a class="social__share--icon text-white" target="_blank" href="https://twitter.com/">
                            ...
                            <li class="social__share--list">
                                <a class="social__share--icon text-white" target="_blank" href="https://www.instagram.com/">
                            ...
                            <li class="social__share--list">
                                <a class="social__share--icon text-white" target="_blank" href="https://www.youtube.com/">
                            ...
                            <li class="social__share--list">
                                <a class="social__share--icon text-white" target="_blank" href="https://www.pinterest.com/">
                                        ...
                                        <li class="header__mega--menu__li fullscreen__style d-flex">
                                            ...
                                            <a class="header__mega--menu__banner display-block" href="shop.html"><img class="header__mega--menu__banner--img" src="assets/img/banner/banner10.webp" alt="banner-menu">
                                                <div class="banner__content">
                                                    ...
                                                    <span class="banner__content--price">$20.99</span>
                                                </div>
                                            </a>
                                        </li>
                                    </ul>
                ...
                <div class="search__filter--section search__filter--style5">
                    <div class="container">
                        <div class="section__heading style2 text-center mb-30">
                            <h2 class="section__heading--maintitle">Search by Vehicle</h2>
                            <p class="section__heading--desc">Filter your results by entering your Vehicle to
                ...
                <div class="row  mb--n30">
                    <div class="col-lg-6 col-md-6 mb-30">
                        <div class="banner__items position__relative">
                            <a class="banner__thumbnail display-block" href="shop.html"><img class="banner__thumbnail--img banner__max--height" src="assets/img/banner/banner1.webp" alt="banner-img">
                                <div class="banner__content">
                    ...
                    <div class="col-lg-6 col-md-6 mb-30">
                        <div class="banner__items position__relative">
                            <a class="banner__thumbnail display-block" href="shop.html"><img class="banner__thumbnail--img banner__max--height" src="assets/img/banner/banner2.webp" alt="banner-img">
                                <div class="banner__content right">
                                    <span class="banner__badge--style2">20% Off</span>
                                    ...
                                    <div class="single__product--preview single__product--thumbnail__preview swiper">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="single__product--thumbnail">
                                                    <a class="single__product--thumbnail__link display-block" href="product-details.html">
                                                        <img class="single__product--thumbnail__img" src="assets/img/product/big-product/product1.webp" alt="product-img">
                                                    </a>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="single__product--thumbnail">
                                                    <a class="single__product--thumbnail__link display-block" href="product-details.html">
                                                        <img class="single__product--thumbnail__img" src="assets/img/product/big-product/product2.webp" alt="product-img">
                                                    </a>
                                                    <span class="product__badge style__left">-14%</span>
                                                    <span class="product__badge--new">New</span>
                                                </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="single__product--thumbnail">
                                                    <a class="single__product--thumbnail__link display-block" href="product-details.html">
                                                        <img class="single__product--thumbnail__img" src="assets/img/product/big-product/product4.webp" alt="product-img">
                                                    </a>
                                                    <span class="product__badge style__left">-14%</span>
                                                    <span class="product__badge--new">New</span>
                                                </div>
                        ...
                        <div class="col-lg-3">
                            <div class="banner__sidebar style5">
                                <div class="banner__items position__relative mb-30">
                                    <a class="banner__thumbnail display-block" href="shop.html"><img class="banner__thumbnail--img" src="assets/img/banner/banner18.webp" alt="banner-img">
                                ...
                                <div class="banner__items position__relative">
                                    <a class="banner__thumbnail display-block" href="shop.html"><img class="banner__thumbnail--img" src="assets/img/banner/banner19.webp" alt="banner-img">
...
<!-- Mirrored from risingtheme.com/html/demo-partsix/partsix/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Apr 2024 17:35:08 GMT -->
</html>